...
SET area='$area',addr='$addr',size='$size',pricing='$method',price='$price'
WHERE uid='$uid'";
...
<head>
	<meta charset="utf-8" />
	<title>Conference Room Post - Formoid form html</title>
...
<form enctype="multipart/form-data" class="formoid-solid-light-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action=""><div class="title"><h2>Conference Room Post Update</h2></div>
	<div class="element-select" title="Sekect Area"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span><select name="area" required>
...
<div class="submit"><input type="submit" value="UPDATE"/></div></form><p class="frmd"><a href="http://formoid.com/v29.php">form html</a> Formoid.com 2.9</p><script type="text/javascript" src="boardroom_files/formoid1/formoid-solid-light-green.js"></script>
<!-- Stop Formoid form-->
