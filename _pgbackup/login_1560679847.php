...
@media screen and (max-width: 300px) {
    ...
    <body> 
        <div id="main" style="height: 600px;"> 
            ...
            <br>
            <br> 
            <p align="center"> <button onclick="document.getElementById('id01').style.display='block'">Login as Space Owner</button></p>
            <br> 
...
var modal = document.getElementById('id01');
            ...
            <p align="center"> <button onclick="document.getElementById('id02').style.display='none'">Login as Client</button></p> 
