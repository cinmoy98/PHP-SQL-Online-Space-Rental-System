			...
			<div class="wrap-contact3">
				<form class="contact3-form validate-form" action="" method="post">
					...
					<div class="wrap-input3 validate-input" data-validate = "NID is required">
						<input class="input3" type="number" name="NID" id="number" placeholder="Your NID" >
						<span class="focus-input3"></span>
					</div>
					...
					<div class="wrap-contact3-form-radio">
						<div class="contact3-form-radio m-r-42">
							<input class="input-radio3" id="radio1" type="radio" name="gender" value="male" checked="checked">
						...
						<div class="contact3-form-radio">
							<input class="input-radio3" id="radio2" type="radio" name="gender" value="female">
					...
					<div class="wrap-input3 validate-input" data-validate = "Message is required">
						...
						<div>
							<select class="selection-2" name="Religion">
