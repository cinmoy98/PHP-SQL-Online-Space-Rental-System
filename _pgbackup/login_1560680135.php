...
@media screen and (max-width: 300px) {
    ...
    <body> 
        <div id="main" style="height: 600px;"> 
            ...
            <br>
            <br> 
            <button onclick="document.getElementById('id01').style.display='block'">Login as Space Owner</button>
            <br> 
...
var modal = document.getElementById('id01');
            ...
            <button onclick="document.getElementById('id02').style.display='block'">Login as Client</button> 
