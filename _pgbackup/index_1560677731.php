...
<html> 
    ...
    <body> 
        ...
        <div style="height: 500px; background-image: url('dexus-office-space.jpg'); background-position: center center; opacity: .8;">
            <h1><p align="center" style="font-size: 48px; color: #61605f;">FIND YOUR office SPACE HERE</p><p align="center" style="font-size: 32px; color: #61605f;"></p><p align="center" style="font-size: 32px; color: #61605f;"></p><p align="center" style="font-size: 32px; color: #61605f; margin-top: -28px;">SPACE FOR</p><p align="center" style="font-size: 25px; color: #61605f;">MEETING&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; EVENT&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; CONFERENCE&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; SEMINAR&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; OFFICE&nbsp; &nbsp; &nbsp;</p></h1>
        </div>
