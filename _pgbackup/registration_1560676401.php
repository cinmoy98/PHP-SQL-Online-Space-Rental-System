...
<body>
  <div id="main">
    <div id="header">
      ...
      <div style="height: 500px; id="content">
	  
	  <div align="left" class="btn-group">
  <a href="reg_own.php"><button>Registration as Land Owners</button></a><br>
  <a href="reg_client.php"><button>Registration as Client</button></a><br>
</div>
