...
<html> 
    ...
    <body> 
        ...
        <div style="height: 500px; background-image: url('dexus-office-space.jpg'); background-position: center center; opacity: .8;">
            <h1><p align="center" style="font-size: 48px; color: #61605f; font-family: Alegreya Sans SC;">FIND YOUR office SPACE HERE</p><p align="center" style="font-size: 32px; color: #61605f;"></p><p align="center" style="font-size: 32px; color: #61605f;"></p><p align="center" style="font-size: 32px; color: #61605f; margin-top: -28px;">SPACE FOR</p><p align="center" style="font-size: 25px; color: #2f2f30; font-family: Alegreya Sans SC;">MEETING&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; EVENT&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; CONFERENCE&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; SEMINAR&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; OFFICE&nbsp; &nbsp; &nbsp;</p></h1>
        </div>
        <div class="pg-empty-placeholder" style="width: 50%; float: left; height: 400px;">
            <h1 style="font-family:serif;"> <p align="center"><u>How can Office-Rental help you?</u></p></h1>
            <p>Choose from any of our locations.Offices for lease by the day ,by the week or by the year.Fully serviced offices with everything included- High-speed internet,Office furnitures and utilities<- just show up and get to work< p>
        </div>
