...
<html> 
    ...
    <body> 
        <div id="main"> 
            ...
            <div style="height: 500px; color: #a8ae0a;" ontent""> 
                <div align="left" class="btn-group"> 
                    <a href="reg_own.php">
                        <button style="float: none; vertical-align: middle;">Registration as Land Owners</button>
                    </a>
                    <br> 
                    <a href="reg_client.php">
                        <button>Registration as Client</button>
                    </a>
                    <br> 
                </div>                 
            </div>             
