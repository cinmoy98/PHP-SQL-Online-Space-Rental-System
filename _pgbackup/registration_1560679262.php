        ...
        <div id="main"> 
            ...
            <div style="height: 400px; color: #a8ae0a; border-top-right-radius: 1px;" ontent""> 
                <div align="left" class="btn-group"> 
                    <a href="reg_own.php">
                        <button style="float: none; vertical-align: middle; background-color: #a8ae0a; height: 32px; padding-right: 6px; margin-right: 76px; margin-left: 398px; margin-top: 101px;">Registration as Land Owners</button>
                    </a>
                    <br> 
                    <a href="reg_client.php">
                        <button style="background-color: #a8ae0a; width: 188px; height: 31px; margin-left: 397px; margin-top: 30px;">Registration as Client</button>
                    </a>
                    <br> 
                </div>                 
            </div>             
