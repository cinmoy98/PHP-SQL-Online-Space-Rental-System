...
$sql="INSERT INTO office(area,addr,size,pricing,pid,price,uid,roomno,furnish) VALUES('$area','$addr','$size','$method','$postid','$price','$uid','$room','$furnished')";
...
if((!mysqli_query($conn,$sql)))//&(!mysqli_query($conn,$sqql))&(!mysqli_query($conn,$sqqql)))
		{
			...
			echo "<script language='javascript' type='text/javascript'> location.href='office.php' </script>";
		}
		else
		{
...
<form enctype="multipart/form-data" class="formoid-solid-light-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Office Room Post</h2></div>
	...
	<div class="element-input" title="Space Size"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" name="input" required="required" placeholder="Space Size"/><span class="icon-place"></span></div></div>
	...
	<div class="element-number" title="Room Number"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="large" type="text" min="0" max="10" name="room" required="required" placeholder="Room Number" value=""/><span class="icon-place"></span></div></div>
