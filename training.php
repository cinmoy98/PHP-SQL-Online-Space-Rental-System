...
$sql="INSERT INTO training(area,addr,size,pricing,pid,price,uid) VALUES('$area','$addr','$size','$method','$postid','$price','$uid')";
...
if((!mysqli_query($conn,$sql)))//&(!mysqli_query($conn,$sqql))&(!mysqli_query($conn,$sqqql)))
		{
			...
			echo "<script language='javascript' type='text/javascript'> location.href='training.php' </script>";
		}
		else
		{
...
<form enctype="multipart/form-data" class="formoid-solid-light-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action=""><div class="title"><h2>Training Room Post</h2></div>
