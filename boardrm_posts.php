...
if(!isset($_POST['filter']))
{
	...
	INNER JOIN userlo ON board.uid=userlo.uid
	");
 ...
 if($_POST['fspace'] != "")
   ...
   if($fmethod== "" && $farea == "")
   {
     if($srtsz == "LH" && $srtprc == "LH"){
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
       WHERE board.size<='$fsize' ORDER BY board.price ASC,board.size ASC ");
      }
     else if($srtsz == "LH" && $srtprc == "HL"){
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
       WHERE board.size<='$fsize' ORDER BY board.price DESC, board.size ASC ");
      }
      else if($srtsz == "HL" && $srtprc == "HL"){
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
       WHERE board.size<='$fsize' ORDER BY board.price DESC,board.size DESC");
      }
      else
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
       WHERE board.size<='$fsize' ORDER BY board.price ASC,board.size DESC");
   ...
   else if($fmethod== "")
   {
    if($srtsz == "LH" && $srtprc == "LH"){
      ...
      $sql=mysqli_query($conn,"SELECT * FROM board
     INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.area='$farea' ORDER BY board.price ASC,board.size ASC ");
      }

       else if($srtsz == "LH" && $srtprc == "HL"){
      $sql=mysqli_query($conn,"SELECT * FROM board
     INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.area='$farea' ORDER BY board.price DESC, board.size ASC");
     }

   else if($srtsz == "HL" && $srtprc == "HL"){
      $sql=mysqli_query($conn,"SELECT * FROM board
     INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.area='$farea' ORDER BY board.price DESC,board.size DESC");
      }

      else
      $sql=mysqli_query($conn,"SELECT * FROM board
     INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.area='$farea' ORDER BY  board.price ASC,board.size DESC");
   }
   ...
   else if($farea == "")
   {
    ...
    if($srtsz == "LH" && $srtprc == "LH"){
      ...
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.pricing='$fmethod'  ORDER BY board.price ASC,board.size ASC ");
      }

       else if($srtsz == "LH" && $srtprc == "HL"){
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.pricing='$fmethod'  board.price DESC, board.size ASC");
      }

   else if($srtsz == "HL" && $srtprc == "HL"){
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.pricing='$fmethod'  ORDER BY board.price DESC,board.size DESC");
      }

      else
      $sql=mysqli_query($conn,"SELECT * FROM board
       INNER JOIN userlo ON board.uid=userlo.uid
      WHERE board.size<='$fsize' AND board.pricing='$fmethod'  ORDER BY  board.price ASC,board.size DESC");
...
if(isset($_POST['sortprice'])||isset($_POST['sortsize']))
{
