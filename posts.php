...
<br>
<div class="al" >
<a href="boardrm.php" ><button class="buttonx buttonb">Post for Boardroom</button></a><br> <br>
<a href="interview.php" ><button class="buttonx buttonb">Post for Interview Room</button></a>
<a href="conference.php" ><button class="buttonx buttonb">Post for Conference Room</button></a><br> <br>
<a href="office.php" ><button class="buttonx buttonb">Post for Ofice Room</button></a>
<a href="training.php" ><button class="buttonx buttonb">Post for Training Room</button></a><br> <br>
